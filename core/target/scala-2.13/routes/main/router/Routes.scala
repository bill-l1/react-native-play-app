...
class Routes(
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:17
    rand_Routes_0: rand.Routes
  ) = this(errorHandler, HomeController_3, CountController_2, AsyncController_0, Assets_1, rand_Routes_0, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_3, CountController_2, AsyncController_0, Assets_1, rand_Routes_0, prefix)
  }
  ...
  def documentation = List(
    ...
    prefixed_rand_Routes_0_5.router.documentation,
    Nil
  ...
  // @LINE:17
  private[this] val prefixed_rand_Routes_0_5 = Include(rand_Routes_0.withPrefix(this.prefix + (if (this.prefix.endsWith("/")) "" else "/") + "v1/rand/"))
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:17
    case prefixed_rand_Routes_0_5(handler) => handler
  }
}
